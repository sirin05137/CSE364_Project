...
public class DataSeeder implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Reader reader = Files.newBufferedReader(Paths.get("/Users/k/K/movies_corrected.csv"));
        ...
        for (CSVRecord csvRecord : records) {
            ...
            BufferedReader imdblink_reader = new BufferedReader(new FileReader("/Users/k/K/links.csv"));
            while(true){
            ...
            BufferedReader imglink_reader = new BufferedReader(new FileReader("/Users/k/K/movie_poster.csv"));
            while(true){
